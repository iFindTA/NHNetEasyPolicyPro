...
@interface NHPhotoLoadingView ()

@property (nonatomic, strong)UILabel *failureLabel;
@property (nonatomic, strong)NHPhotoProgressView *progressView;

@end

@implementation NHPhotoLoadingView
...
- (void)showLoading
{
    ...
    if (_progressView == nil) {
        _progressView = [[NHPhotoProgressView alloc] init];
